<div class="container">
	<?php switch ($mode):
		...
		case 'failed':
			...
			<div class="alert alert-danger fade in alert-dismissable center-block" style="max-width: 600px;" role="alert">
				<a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">x</a>
				<strong>Error!</strong> There was an error creating the project.
			</div>
		<?php break;
		case 'create': ?>
			...
			<form class="center-block jumbotron" enctype="multipart/form-data" style="max-width: 700px;" action="<?php echo APP_URL ?>/project/create" method="post">
				...
				<div class="form-group <?php if (isset($profpicError)) {
											echo 'has-error';
										} ?>">
				...
				<div class="form-group <?php if (isset($pnameError)) {
											echo 'has-error';
										} ?>">
				...
				<div class="form-group <?php if (isset($desError)) {
											echo 'has-error';
										} ?>">
				...
				<div class="form-group <?php if (isset($tagError)) {
											echo 'has-error';
										} ?>">
				...
				<div class="form-group <?php if (isset($minError)) {
											echo 'has-error';
										} ?>">
				...
				<div class="form-group <?php if (isset($maxError)) {
											echo 'has-error';
										} ?>">
				...
				<div class="form-group <?php if (isset($endtimeError)) {
											echo 'has-error';
										} ?>">
				...
				<div class="form-group <?php if (isset($pctError)) {
											echo 'has-error';
										} ?>">
