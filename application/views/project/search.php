        ...
        <div class="col-xs-12 col-md-6">
          <div class="thumbnail">
            <a href="<?php echo APP_URL . "/project/view/" . $row['pid']; ?>">
              <img style="height: 300px; border-radius:10px" src="<?php echo APP_URL . IMG_PROJ_URL . "profile/" . (empty($row['profpic']) ? "default.png" : $row['profpic']) ?>" alt="Project Profile Picture">
            </a>
            <div class="caption">
