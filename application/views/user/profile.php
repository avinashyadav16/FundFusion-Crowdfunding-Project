<div class="container">
	<?php switch ($mode):
		...
		case 'failed':
			...
			<div class="center-block alert alert-danger fade in alert-dismissable" style="max-width: 600px;" role="alert">
				<a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">x</a>
				<strong>Error</strong>
	...
	<form class="center-block jumbotron" style="max-width: 600px;" action="<?php echo APP_URL; ?>/user/profile" method="post">
		...
		<div class="form-group <?php if (isset($unameError)) {
									echo 'has-error';
								} ?>">
		...
		<div class="form-group <?php if (isset($upwdError)) {
									echo 'has-error';
								} ?>">
		...
		<div class="form-group <?php if (isset($nameError)) {
									echo 'has-error';
								} ?>">
		...
		<div class="form-group <?php if (isset($ccnError)) {
									echo 'has-error';
								} ?>">
		...
		<div class="form-group <?php if (isset($emailError)) {
									echo 'has-error';
								} ?>">
		...
		<div class="form-group <?php if (isset($interestError)) {
									echo 'has-error';
								} ?>">
