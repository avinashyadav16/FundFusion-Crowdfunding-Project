<div class="center-block jumbotron" style="max-width: 600px;">
  <div class="container">
    <div class="row">
      <h4 class="col-md-6 text-right">Username</h4>
      <h4 class="col-md-6 text-muted text-left"><?php echo $row['uname']; ?></h4>
    </div>
    <div class="row">
      <h4 class="col-md-6 text-right">Email</h4>
      <h4 class="col-md-6 text-muted text-left"><?php echo $row['email']; ?></h4>
    </div>
    <div class="row">
